using System;ApplicationDbContext
...
namespace organic.Areas.Admin.Controllers
{
    ...
    public class UrunController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Ad,Fiyat,Miktar,Birim,UretimYeri,Aciklama,KategoriId")] Urun urun)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Ad,Fiyat,Miktar,Birim,UretimYeri,Aciklama,KategoriId")] Urun urun)
        {
            if (id != urun.Id)
            {
                return NotFound();
